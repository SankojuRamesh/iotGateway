...
DATABASES = {
    "default": {
        ...
        "NAME": env("POSTGRES_DB", default="iotgateway"),
        "USER": env("POSTGRES_USER", default="iotgateway"),
        "PASSWORD": env("POSTGRES_PASSWORD", default="iotgateway"),
...
DEVICE_OFFLINE_THRESHOLD_SECONDS = env.int(
    "DEVICE_OFFLINE_THRESHOLD_SECONDS", default=300
)
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="no-reply@iotgateway.local")
...
LOGGING = {
    ...
    "loggers": {
        "mqtt_ingest": {"handlers": ["console"], "level": "DEBUG", "propagate": False},
    },
}
